...
namespace SharedModels
{
    public partial class dbContext : DbContext
    {
        ...
        public virtual DbSet<MDiplomasOrDegree> MDiplomasOrDegrees { get; set; }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseMySql(Globals.AppSettings.connection_string, Microsoft.EntityFrameworkCore.ServerVersion.Parse("5.7.33-mysql"));
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<MAspnetUserLanguage>(entity =>
            {
                ...
                entity.HasOne(d => d.LanguageIdFkNavigation)
                    ...
                    .HasConstraintName("FK_m_aspnet_user_languages_m_languages_2");
            ...
            modelBuilder.Entity<MDiplomasOrDegree>(entity =>
            {
                entity.ToTable("m_diplomas_or_degrees");

                entity.HasComment("list of diplomas or degrees");

                entity.Property(e => e.Id)
                    .HasColumnType("int(11)")
                    .HasColumnName("id");

                entity.Property(e => e.DegreeOrDiploma)
                    .HasMaxLength(100)
                    .HasColumnName("degree_or_diploma");
            });
